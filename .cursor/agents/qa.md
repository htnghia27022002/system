...
**Prerequisites:** `spec.md`; for sign-off → implement done by `@be`/`@fe` with `be-tasks-verify.md` / `fe-tasks-verify.md`, run `make test`. Design docs (`tasks.md`, `plan.md`, `contracts/*`) come from `@technical-architect`.
